 ...
 * date           : 2026-07-27
 * description    : 사용자 메뉴 로직의 동작을 검증함
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class UserMenuServiceImplTest {
    ...
    void getCurrentVisibleMenu() {
        ...
        // 2단계 메뉴가 최상위 메뉴의 하위 목록에 연결됐는지 검증함
        assertEquals(List.of(secondMenu), visibleMenu.getChildList());
        // 3단계 메뉴가 2단계 메뉴의 하위 목록에 연결됐는지 검증함
    ...
    /**
     * URL에 해당하는 메뉴가 없어도 실패시키지 않고 로고 표시를 위한 null 메뉴를 반환하는지 검증함
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    /**
     * 설정 화면 조회에서는 설정 루트를 제외하고 2·3단계 메뉴 트리만 반환하는지 검증함
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    void getSettingsMenuChildren() {
        ...
        // 공통 응답에서 설정 화면에 표시할 2단계 메뉴 목록을 조회함

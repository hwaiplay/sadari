...
class UserMenuServiceImplTest {
    ...
    /**
     * URL에 해당하는 메뉴가 없어도 실패시키지 않고 로고 표시를 위한 null 메뉴를 반환하는지 검증
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    /**
     * 설정 화면 조회에서는 설정 루트를 제외하고 2·3단계 메뉴 트리만 반환하는지 검증
     *
     * @author SeungHyeon.Kang
     */
    @Test

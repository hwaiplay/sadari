...
class InquiryServiceImplTest {
    ...
    void setUp() {
        ...
        // 실패 응답이 실제 공통 메시지 소스를 사용하도록 정적 조회 객체를 초기화한다
        new MessageUtils().setMessageSource(messageSource);
        // 고객문의 서비스 단위 테스트 대상을 생성한다

 ...
 * date           : 2026-07-30
 * description    : 기간 정지 만료와 우선 상태 보존을 검증
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class UserSuspensionServiceImplTest {
    ...
    /**
     * 활성 정지 이력이 없고 DB가 정상 상태이면 남은 Redis 정지 상태를 보정하는지 확인
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    /**
     * DB가 여전히 정지 상태이면 활성 이력이 없어도 접근 제한을 임의로 해제하지 않는지 확인
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    /**
     * 정지 만료 시 DB 회원 상태가 실제 복구된 경우에만 Redis 상태도 복구하는지 확인
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    /**
     * 영구 삭제 대기 같은 우선 상태가 남으면 정지 만료가 Redis 상태를 덮지 않는지 확인
     *
     * @author SeungHyeon.Kang
     */
    @Test

...
class AlimDeleteServiceImplTest {
    ...
    /**
     * 실제 삭제 건수가 대상 및 성공 건수에 동일하게 기록되는지 검증함
     *
     * @author SeungHyeon.Kang
     */
    @Test
    ...
    /**
     * 삭제 대상이 없을 때 불필요한 스케줄러 로그를 저장하지 않는지 검증함
     *
     * @author SeungHyeon.Kang
     */
    @Test

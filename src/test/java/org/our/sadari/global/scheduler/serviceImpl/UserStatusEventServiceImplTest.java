 ...
 * date           : 2026-07-30
 * description    : 회원 상태 변경 Outbox의 Redis 반영과 재시도 조건을 검증
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class UserStatusEventServiceImplTest {
    ...
    /**
     * 한 번에 100건을 처리하는 테스트 대상 서비스를 구성
     *
     * @author SeungHyeon.Kang
     */
    @BeforeEach
    ...
    /**
     * 처리할 이벤트가 없으면 Redis와 스케줄러 실행 이력을 건드리지 않는지 확인
     *
     * @author SeungHyeon.Kang
     */
    @Test

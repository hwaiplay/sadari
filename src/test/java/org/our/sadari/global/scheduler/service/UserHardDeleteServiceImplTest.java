 ...
 * date           : 2026-08-06
 * description    : 영구 탈퇴 회원의 DB 데이터와 물리 파일 삭제 연계를 검증
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class UserHardDeleteServiceImplTest {
    ...
    /**
     * 각 테스트에서 영구 삭제 대상 조회 제한 건수를 설정
     *
     * @author SeungHyeon.Kang
     */
    @BeforeEach
    void setUp() {
        // 영구 삭제 대상 한 건을 조회할 최대 처리 건수를 설정
        ReflectionTestUtils.setField(userHardDeleteService, "maxSize", 100);
    }

    /**
     * 영구 탈퇴 회원의 파일 정보를 DB 삭제 전에 확보하고 삭제 커밋 후 물리 파일 정리를 등록하는지 검증
     *
     * @author SeungHyeon.Kang
     */
    @Test

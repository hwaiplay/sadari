 ...
 * date           : 2026-08-07
 * description    : S3 이미지 객체 쓰기와 객체 부재 처리 계약을 검증함
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class S3FileStorageTest {
    ...
    /**
     * S3 객체 쓰기 요청에 버킷과 MIME 유형 및 비공개 객체 키가 전달되는지 검증함
     *
     * @author SeungHyeon.Kang

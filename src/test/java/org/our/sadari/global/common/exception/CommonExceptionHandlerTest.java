 ...
 * author         : HanWon.Jang
 * date           : 2026-08-27
 * description    : 공통 예외 처리기의 JDBC 연결 장애 판정 범위를 검증한다
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------

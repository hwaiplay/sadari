 ...
 * author         : HanWon.Jang
 * date           : 2026-08-28
 * description    : 모임장 선거의 동률 결선 생성 경로를 검증한다
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class OwnerElectionServiceImplTest {
    ...
    /** 이미 투표한 유권자의 결과 변경 요청을 저장하지 않는다. */
    @Test

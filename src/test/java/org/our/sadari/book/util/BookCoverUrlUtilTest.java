 ...
 * date           : 2026-08-02
 * description    : 카카오 도서 썸네일의 Daum 원본 표지 주소 변환을 검증함
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class BookCoverUrlUtilTest {
    ...
    /**
     * 카카오 썸네일 fname 주소를 HTTPS Daum 원본 주소로 변환하는지 검증함
     *
     * @author SeungHyeon.Kang
     */
    @Test

 ...
 * date           : 2026-08-25
 * description    : 본인과 팔로잉 피드 및 사진 반응 데이터 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface FeedMapper {
    ...
    /**
     * 로그인 사용자 본인과 팔로우하는 활성 사용자의 공개 활동 피드를 최신순으로 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 현재 프로필 또는 배경 이미지와 일치하는 활성 사용자 소유 좋아요 대상을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 교체되는 프로필 또는 배경 이미지의 댓글에 연결된 좋아요를 삭제
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 교체되는 프로필 또는 배경 이미지의 부모 댓글에 연결된 답글을 삭제
     *
     * @author SeungHyeon.Kang
     * @param request 교체되는 사진 유형과 파일 번호
     * @return 삭제된 답글 수
    ...
    /**
     * 교체되는 프로필 또는 배경 이미지에 직접 연결된 부모 댓글을 삭제
     *
     * @author SeungHyeon.Kang
     * @param request 교체되는 사진 유형과 파일 번호
     * @return 삭제된 부모 댓글 수
    ...
    /**
     * 교체되는 프로필 또는 배경 이미지에 직접 연결된 좋아요를 삭제
     *
     * @author SeungHyeon.Kang
     * @param request 교체되는 사진 유형과 파일 번호
     * @return 삭제된 사진 좋아요 수

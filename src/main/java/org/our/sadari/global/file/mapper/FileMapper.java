 ...
 * date           : 2026-07-14
 * description    : 이미지 파일 데이터베이스 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface FileMapper {
    ...
    /**
     * 현재 활성 회원의 프로필 또는 배경으로 참조되는 공개 파일 수를 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 현재 활성 회원의 프로필 또는 배경으로 참조되는 파일 소유자 번호를 조회
     *
     * @author HanWon.Jang
     * @param storName 서버가 생성한 저장 파일명
     * @param filePath 공개 업로드 경로
    ...
    /**
     * 파일 등록 사용자 번호로 영구 삭제할 파일 메타정보를 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 사용자 프로필과 배경에서 참조하지 않는 파일 메타정보를 삭제
     *
     * @author SeungHyeon.Kang

 ...
 * date           : 2026-07-29
 * description    : 영구 삭제 예정 회원 조회와 회원 연관 데이터 삭제 SQL을 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface UserHardDeleteMapper {
    ...
    /**
     * 삭제 예정일이 지난 영구 탈퇴 회원을 제한 건수만큼 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 피신고자 연결 익명화 전에 해당 회원의 미처리 신고를 시스템 종결
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 로그인 이력을 익명화하고 회원 연관 데이터와 회원 원본을 물리 삭제
     *
     * @author SeungHyeon.Kang

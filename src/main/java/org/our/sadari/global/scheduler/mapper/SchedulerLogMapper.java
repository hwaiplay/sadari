...
/**
 * 스케줄러 실행 요약과 실패 상세 로그를 TL_SCLOGX, TL_SCFAIL에 기록하는 MyBatis Mapper입니다.
 *
...
public interface SchedulerLogMapper {
    ...
    /**
     * 스케줄러 실행 시작 정보를 TL_SCLOGX에 등록합니다.
     *
     * @author Seunghyeon.Kang
    ...
    /**
     * 스케줄러의 최종 상태와 처리 건수 및 실행 시간을 TL_SCLOGX에 수정합니다.
     *
     * @author Seunghyeon.Kang
    ...
    /**
     * 스케줄러 실패 정보를 실행 번호별 다음 실패 순번으로 TL_SCFAIL에 등록합니다.
     *
     * @author Seunghyeon.Kang

...
/**
 * 스케줄러 실행 요약과 실패 상세 로그의 등록 및 종료 상태 수정을 정의합니다.
 *
...
public interface SchedulerLogService {
    ...
    /**
     * 스케줄러 실행 시작 로그를 등록하고 발급된 실행 번호를 반환합니다.
     *
     * @author Seunghyeon.Kang
    ...
    /**
     * 스케줄러 실행 로그에 최종 상태, 처리 건수, 실행 시간을 반영합니다.
     *
     * @author Seunghyeon.Kang
    ...
    /**
     * 스케줄러 실행 중 발생한 실패 한 건을 TL_SCFAIL에 등록합니다.
     *
     * @author Seunghyeon.Kang

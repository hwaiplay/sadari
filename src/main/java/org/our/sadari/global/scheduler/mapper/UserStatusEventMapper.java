 ...
 * date           : 2026-07-30
 * description    : 회원 상태 변경 Outbox 전달과 정지 동기화 상태 SQL을 연결
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface UserStatusEventMapper {
    ...
    /**
     * 등록 순서대로 처리할 회원 상태 변경 이벤트와 현재 회원 상태를 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 사용자 서버 반영이 필요한 회원 상태 변경 Outbox 이벤트를 등록
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 최신 전달 이벤트까지 처리한 정지 이력을 사용자 서버 반영 완료 상태로 변경
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * Redis 상태 동기화를 마친 Outbox 이벤트를 삭제
     *
     * @author SeungHyeon.Kang

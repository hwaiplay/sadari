 ...
 * date           : 2026-07-27
 * description    : 사용자 메뉴 데이터베이스 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface UserMenuMapper {
    ...
    /**
     * 현재 URL과 정확히 일치하거나 동적 상세 URL의 접두 경로와 일치하는 메뉴 한 건을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 노출 여부와 사용 여부가 모두 Y인 햄버거 메뉴 목록을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 기준 화면의 사용 중 메뉴를 부모로 하는 노출 가능한 하위 메뉴를 조회
     *
     * @author SeungHyeon.Kang

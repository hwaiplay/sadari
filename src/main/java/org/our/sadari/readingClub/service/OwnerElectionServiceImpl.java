 ...
 * author         : HanWon.Jang
 * date           : 2026-08-28
 * description    : 모임장 승계 선거의 후보 고정, 비밀투표, 결선과 권한 변경을 처리한다
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class OwnerElectionServiceImpl implements OwnerElectionService {
    ...
    public void startPendingElection() {
        // 모임 행 잠금으로 모임별 번호 계산과 중복 선거 생성을 직렬화한다
    ...
    public void completeDueElection() {
        // 마감 대상 투표를 잠가 중복 당선과 중복 결선을 방지한다
    ...
    /**
     * 본선 동률 후보와 현재 활성 유권자로 결선 투표를 생성한다
     *
     * @author HanWon.Jang

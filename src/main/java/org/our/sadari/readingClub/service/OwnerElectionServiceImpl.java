 ...
 * author         : HanWon.Jang
 * date           : 2026-08-28
 * description    : 모임장 승계 선거의 후보 고정, 비밀투표, 결선과 권한 변경을 처리
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class OwnerElectionServiceImpl implements OwnerElectionService {
    ...
    public ResultData uptElectionVote(Long userNumb, Long clubNumb
        ...
        // 고유키와 중복 무시 INSERT로 동시에 요청해도 최초 한 표만 저장
    ...
    public void startPendingElection() {
        // 모임 행 잠금으로 모임별 번호 계산과 중복 선거 생성을 직렬화
    ...
    /**
     * 본선 동률 후보와 현재 활성 유권자로 결선 투표를 생성
     *
     * @author HanWon.Jang

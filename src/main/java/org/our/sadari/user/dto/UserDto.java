 ...
 * date           : 2026-07-17
 * description    : 사용자 요청과 응답 데이터를 전달
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class UserDto {
    ...
    /**
     * 일반 프로필 화면에서 사용할 축소 배경사진 경로를 반환
     *
     * @author HanWon.Jang
     * @return 화면용 배경사진 경로
     */
    ...
    public String getBgimDisplayPath() {
        // DB 원본 경로는 유지하고 API 직렬화 시 화면용 파생본 URL을 추가
        return FileUrlUtil.getBgDisplayPath(bgimPath);
    }

    /**
     * 마이페이지의 현재 프로필 또는 배경 사진에 표시할 좋아요와 댓글 집계를 전달
     *
     * @author SeungHyeon.Kang
     */
    @Data
    ...
    /**
     * 회원이 선택하거나 화면에 노출할 독서 관심분야 항목을 전달
     *
     * @author SeungHyeon.Kang
     */
    @Data

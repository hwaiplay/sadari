 ...
 * date           : 2026-07-29
 * description    : 계정 비활성화 및 영구 탈퇴 재인증과 영구 삭제 대기 취소 API를 제공
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class UserWithdrawalController {
    ...
    /**
     * 계정 처리 정책 입력값을 저장하고 Kakao 재인증 URL을 발급
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 로그인 회원의 영구 삭제 예정일과 취소 가능 상태를 조회
     *
     * @author SeungHyeon.Kang
     * @param userNumb 로그인 회원 번호
     * @return 영구 삭제 대기 정보

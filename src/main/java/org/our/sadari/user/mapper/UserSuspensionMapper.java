 ...
 * date           : 2026-07-30
 * description    : 사용자 회원 정지 상태 조회와 기간 만료 SQL을 연결
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface UserSuspensionMapper {
    ...
    /**
     * 회원에게 현재 활성 상태로 남아 있는 최신 정지 이력을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 회원 상태가 복구된 정지 이력을 사용자 서버 반영 대기 상태로 변경
     *
     * @author SeungHyeon.Kang

 ...
 * date           : 2026-07-29
 * description    : 회원 탈퇴 상태와 연관 데이터 변경 SQL을 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface UserWithdrawalMapper {
    ...
    /**
     * 계정 비활성화 또는 영구 삭제 대기 회원의 독서 통계를 비공개로 변경
     *
     * @author SeungHyeon.Kang
     * @param userNumb 탈퇴 회원 번호
    ...
    /**
     * 계정 비활성화 또는 영구 삭제 대기 회원의 모임 회차 참여 연결을 비식별화
     *
     * @author SeungHyeon.Kang
     * @param userNumb 탈퇴 회원 번호
    ...
    /**
     * 계정 비활성화 또는 삭제 대기 전환 사용자의 신고 결과 수신 이력을 삭제
     *
     * @author HanWon.Jang
     * @param userNumb 탈퇴 회원 번호
     * @return 삭제된 신고 결과 수
    ...
    /**
     * 같은 OAuth 식별값으로 탈퇴한 모든 과거 회원 번호에 유효한 이용 정지가 있는지 조회
     *
     * @author SeungHyeon.Kang

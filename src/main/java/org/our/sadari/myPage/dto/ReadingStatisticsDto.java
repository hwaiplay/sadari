 ...
 * date           : 2026-08-14
 * description    : 마이페이지의 독서 시간과 습관 및 독후감 통계를 전달
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class ReadingStatisticsDto {
    ...
    /**
     * 타이머 기록이 이어진 현재 및 최장 연속 독서일을 전달
     *
     * @author SeungHyeon.Kang
     */
    @Data
    ...
    /**
     * 현재 연도에 타이머로 오래 읽은 도서와 누적 시간을 전달
     *
     * @author SeungHyeon.Kang
     */
    @Data
    ...
    /**
     * 현재 연도와 전년도 같은 기간의 독서 시간과 독서일 및 완독 권수를 전달
     *
     * @author SeungHyeon.Kang
     */
    @Data

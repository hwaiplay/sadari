 ...
 * date           : 2026-08-14
 * description    : 본인과 공개 프로필의 독서 시간과 습관 및 독후감 통계 SQL 계약을 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface ReadingStatisticsMapper {
    ...
    /**
     * 조회 가능한 기록 연도와 선택 연도의 일별 독서 시간을 한 번에 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 현재 연도에 완료한 타이머 시간을 도서별로 합산해 상위 세 권을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 정상 이용 회원의 범용 설정 행에 독서 통계 공개 범위를 저장
     *
     * @author SeungHyeon.Kang

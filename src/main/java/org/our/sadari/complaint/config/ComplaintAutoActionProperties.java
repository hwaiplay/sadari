 ...
 * date           : 2026-08-22
 * description    : 신고 대상별 누적 자동 조치 임계치를 관리
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class ComplaintAutoActionProperties {
    ...
    public int getThreshold(String tagtType) {
        // 자동 조치 대상 유형은 설정 파일의 개별 임계치와 고정 매핑

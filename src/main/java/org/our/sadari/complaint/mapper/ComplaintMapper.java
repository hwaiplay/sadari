 ...
 * date           : 2026-08-22
 * description    : 신고 대상 원문과 누적 건수를 조회하고 신고 및 자동 조치 이력을 저장
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface ComplaintMapper {
    ...
    /**
     * 요청한 신고 대상 유형 또는 사유가 활성 공통코드인지 조회
     *
     * @author SeungHyeon.Kang
     * @param commCode 공통코드
     * @param comdCode 세부코드
    ...
    /**
     * 동일 사용자가 같은 대상 버전을 신고한 이력이 있는지 확인
     *
     * @author SeungHyeon.Kang
     * @param userNumb 신고자 사용자 번호
    ...
    /**
     * 신고 시점에 저장할 다른 사용자의 프로필 내용과 소유자를 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 신고 시점에 저장할 다른 사용자의 공개 독후감 본문과 소유자를 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 신고 시점에 저장할 다른 사용자의 공개 독후감 댓글 본문과 소유자를 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 신고 시점에 저장할 다른 사용자의 현재 프로필 사진 정보와 소유자를 잠금 조회
     *
     * @author SeungHyeon.Kang
     * @param tagtNumb 신고 대상 사용자 번호
     * @param userNumb 신고자 사용자 번호
    ...
    /**
     * 신고 시점에 저장할 다른 사용자의 현재 배경사진 정보와 소유자를 잠금 조회
     *
     * @author SeungHyeon.Kang
     * @param tagtNumb 신고 대상 사용자 번호
     * @param userNumb 신고자 사용자 번호
    ...
    /**
     * 신고 시점에 저장할 다른 사용자의 현재 한줄소개와 소유자를 잠금 조회
     *
     * @author SeungHyeon.Kang
     * @param tagtNumb 신고 대상 사용자 번호
     * @param userNumb 신고자 사용자 번호
    ...
    /**
     * 서버에서 확정한 대상 내용과 신고 사유를 접수 이력으로 저장
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 반려를 제외한 동일 대상 버전의 유효 누적 신고 건수를 조회
     *
     * @author SeungHyeon.Kang
     * @param tagtType 신고 대상 유형
     * @param tagtNumb 신고 대상 번호
    ...
    /**
     * 신고 누적 임계치에 도달한 프로필 사진을 기본 이미지 상태로 변경
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 신고 누적 임계치에 도달한 배경사진을 기본 이미지 상태로 변경
     *
     * @author SeungHyeon.Kang
     * @param tagtUser 신고 대상 사용자 번호
     * @return 변경된 사용자 수
    ...
    /**
     * 신고 누적 자동 조치 결과를 변경 불가능한 이력으로 저장
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 동일 대상의 접수 또는 검토 중 신고를 자동 조치 완료 상태로 변경
     *
     * @author SeungHyeon.Kang
     * @param tagtType 신고 대상 유형
     * @param tagtNumb 신고 대상 번호
    ...
    /**
     * 자동 조치로 종결된 동일 대상 버전 신고의 신고자별 미확인 결과를 생성
     *
     * @author HanWon.Jang
     * @param tagtType 신고 대상 유형
     * @param tagtNumb 신고 대상 번호
    ...
    /**
     * 활성 사용자의 조회 시점 마지막 번호까지 미확인 결과를 확인 처리
     *
     * @author HanWon.Jang
     * @param userNumb 인증 사용자 번호
    ...
    /**
     * 최종 처리 뒤 정책 보존기간이 지난 비공개 이미지 증거를 제한 건수만큼 삭제
     *
     * @author SeungHyeon.Kang

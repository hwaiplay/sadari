 ...
 * date           : 2026-08-16
 * description    : 주간과 월간 및 연간 독후감 작성자 수를 기준으로 인기 도서 목록을 구성
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class BookPopularService {
    ...
    /**
     * 선택한 현재 주와 달 또는 연도에 독후감을 작성한 고유 회원 수 기준 인기 도서를 최대 10권 조회
     *
     * @author SeungHyeon.Kang
    ...
    public ResultData getPopularBookList(String period) {
        ...
        // 비어 있거나 지원하지 않는 기간은 임의의 넓은 집계 범위로 해석하지 않고 요청을 차단

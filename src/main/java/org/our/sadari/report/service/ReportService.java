 ...
 * date           : 2026-07-17
 * description    : 독후감과 독서 목표 업무 계약을 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface ReportService {
    ...
    /**
     * 로그인 사용자의 독후감 상세 정보와 연결된 도서 정보를 조회
     *
     * @author SeungHyeon.Kang
     * @param userNumb 로그인 사용자 번호
    ...
    /**
     * ISBN 기준으로 도서의 평균 별점을 조회
     * 평균 별점은 공개 여부와 관계없이 읽는 중 상태를 제외하고 계산
     *
     * @author SeungHyeon.Kang
     * @param bookIsbn 조회할 도서 ISBN
     * @return 평균 별점 조회 결과
    ...
    /**
     * 로그인 사용자의 독후감 목록을 검색어와 정렬 조건으로 조회
     *
     * @author SeungHyeon.Kang
     * @param userNumb 로그인 사용자 번호
    ...
    /**
     * 로그인 사용자의 독후감을 검색어와 정렬 조건에 따라 페이지 단위로 조회
     *
     * @author SeungHyeon.Kang
     * @param userNumb 로그인 사용자 번호
     * @param bookKeyword 책 제목 또는 작가명 검색어
    ...
    /**
     * 본인 또는 다른 사용자 화면에 표시할 주간, 월간, 연간 독서 요약과 목표 정보를 조회
     *
     * @author SeungHyeon.Kang
    ...
    // copyPreviousReadingGoal 호출로 이전 목표값을 새 목표에 반영

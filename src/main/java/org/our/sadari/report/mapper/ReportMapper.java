 ...
 * date           : 2026-07-17
 * description    : 독후감과 독서 목표 데이터베이스 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface ReportMapper {
    ...
    /**
     * 본인 또는 다른 사용자 프로필의 기간별 독서량과 목표 달성 정보를 통합 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 본인 또는 다른 사용자 프로필에 표시할 현재 읽는 책과 올해 완료한 책을 한 번에 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 사용자, 목표 기간, 목표 유형에 해당하는 독서 목표를 조회
     *
     * @author SeungHyeon.Kang
     * @param req 목표 조회 조건
     * @return 독서 목표 정보
    ...
    /**
     * 좋아요를 허용할 수 있는 독후감의 작성자와 좋아요 알림 설정을 조회
     * TB_LIKEXX 변경은 SocialMapper에서 처리하지만, 대상 검증 기준은 TM_REPORT이므로 ReportMapper에서 관리
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * ISBN 기준 활성 사용자의 공개 독후감을 팔로우 작성자 우선으로 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 공개 범위와 차단 관계를 검증한 독후감 원문을 잠금 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 독후감과 대상 언어별 번역 캐시를 신규 저장하거나 원문 변경 내용으로 갱신
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * ISBN 기준으로 연결된 완료 또는 중단 독후감의 평균 별점을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 로그인 사용자가 작성한 독후감의 좋아요 알림 여부를 변경
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 로그인 사용자가 작성한 독후감의 댓글 알림 여부를 변경
     *
     * @author SeungHyeon.Kang
     * @param reportAlimDto 사용자 번호, 독후감 번호와 알림 사용 여부
     * @return 반영 건수
    ...
    /**
     * 독후감의 읽기 상태와 별점 및 공개 여부를 빠르게 수정
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 진행 중인 모임 회차의 연결 독후감 삭제 전 참여 기록을 중도하차로 확정
     *
     * @author HanWon.Jang

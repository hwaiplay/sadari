 ...
 * date           : 2026-08-10
 * description    : 활성 사용자에게 서비스 정보 카테고리와 현재 배포 버전만 제공
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class ServiceInfoServiceImpl implements ServiceInfoService {
    ...
    /**
     * 활성 사용자에게 서비스 정보 카테고리와 현재 배포본을 제공
     *
     * @author SeungHyeon.Kang
    ...
    public ResultData getPrivacyPolicy() {
        // 공개 가능한 개인정보처리방침 카테고리의 현재 배포본만 조회

 ...
 * date           : 2026-07-22
 * description    : 사용자 검색과 팔로우 및 좋아요 데이터베이스 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface SocialMapper {
    ...
    /**
     * 로그인 사용자와 상대 사용자 번호를 기준으로 화면에 표시할 팔로우 버튼명을 조회
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 로그인 사용자가 상대 사용자를 팔로우하도록 TB_FOLLOW에 관계를 저장
     *
     * @author SeungHyeon.Kang
     * @param req 로그인 사용자 번호와 상대 사용자 번호
     * @return 반영 건수
    ...
    /**
     * 좋아요 토글 후 화면에 표시할 좋아요 상태와 개수를 조회
     *
     * @author SeungHyeon.Kang
     * @param req 사용자 번호, 대상 유형, 대상 번호
     * @return 좋아요 상세 정보
    ...
    /**
     * 프로필 통계에 표시할 총 읽은 책, 팔로우, 팔로워, 받은 좋아요 수를 한 번에 조회
     * 다른 사용자 프로필은 공개 독후감 조건을 적용하고 본인 마이페이지는 전체 독후감 집계를 유지
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 닉네임이 검색어를 포함하는 활성 사용자를 로그인 사용자와의 관계순으로 조회
     *
     * @author HanWon.Jang
     ...
     * 각 행에는 로그인 사용자 기준 팔로우 상태를 함께 내려 화면 오른쪽 버튼 상태를 별도 API 없이 표시
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 로그인 사용자가 좋아요 대상의 사용자 목록을 조회할 수 있는지 확인
     *
     * @author SeungHyeon.Kang

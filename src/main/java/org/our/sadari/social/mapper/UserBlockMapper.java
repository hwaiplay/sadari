 ...
 * author         : HanWon.Jang
 * date           : 2026-09-03
 * description    : 사용자 차단 관계의 저장과 조회 데이터 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface UserBlockMapper {
    ...
    /**
     * 한 당사자가 모임장인 모임에 상대가 제출한 처리 중 가입 신청을 삭제
     *
     * @author HanWon.Jang
     * @param blockDto 차단 사용자와 대상 정보
     * @return 삭제된 가입 신청 수
    ...
    /**
     * 로그인 사용자가 직접 차단한 사용자 목록을 최신순으로 조회
     *
     * @author HanWon.Jang

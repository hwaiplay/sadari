 ...
 * date           : 2026-08-13
 * description    : 사용자 고객문의 접수와 본인 문의 조회 API를 제공
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class InquiryController {
    ...
    /**
     * 현재 이용정지 이후 접수한 최신 이의제기 문의 번호를 조회
     *
     * @author SeungHyeon.Kang
    ...
    public ResultData getSuspInquiryNumb(
        ...
        // 정지 안내 화면의 문의 버튼 이동에 사용할 본인 문의 번호를 반환
    ...
    public ResultData setInquiry(
        ...
        // 인증 사용자의 새 고객문의를 접수하고 문의 번호를 반환

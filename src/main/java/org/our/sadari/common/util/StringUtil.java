package org.our.sadari.common.util;
...
//			Log.debug("putContentsStrCnvr");
     ...
     * 사용예) getFormattedNumber("200102042345")
     * 결 과 ) 200,102,042,345
    ...
    public static String getFormattedNumber(String pInstr) {
        ...
        try {
            // 수정된 부분: new Long(pInstr) 대신 Long.valueOf(pInstr) 사용
     ...
     * ex String a="A1234B" => splitResult(a,"A","B") 반환은 1234
     * @param source 원본 문자열
     * @param str1 시작점
     * @param str2 종료점
     *

 ...
 * date           : 2026-07-25
 * description    : 푸시 알림 요청과 응답 데이터를 전달
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class PushDto {
    ...
    /**
     * 브라우저가 FCM token을 발급받기 위해 필요한 Firebase Web 설정 DTO
    ...
    /**
     * TB_PSHSUB에 저장할 푸시 구독 DTO
     * FCM 토큰은 ENDP_URLX 컬럼에 저장하고 p256dh와 auth 키는 일반 Web Push 전환을 위해 유지
     *
     * @author SeungHyeon.Kang
     */
    // 사용자 브라우저의 푸시 구독 정보

 ...
 * date           : 2026-07-25
 * description    : 푸시 알림 데이터베이스 접근 메서드를 정의
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public interface PushMapper {
    /**
     * FCM token을 구독 정보로 저장하거나, 이미 있으면 다시 활성화
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 같은 브라우저 token이 다른 계정에 연결돼 있으면 이전 계정 구독을 비활성화
     *
     * @author SeungHyeon.Kang
    ...
    /**
     * 사용자가 현재 브라우저의 푸시 구독을 끌 때 해당 token을 비활성화
     *
     * @author SeungHyeon.Kang
     * @param req 사용자 번호와 FCM token
     * @return 반영 건수

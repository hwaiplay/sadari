...
/**
 * 인증 사용자의 콘텐츠 신고를 대상 원문 스냅샷과 함께 접수함
 *
...
export const uptResultConfirmApi = async (resultNumb: number): Promise<void> => {
  // 조회 이후 생성된 결과를 제외하도록 마지막 결과 번호를 경로에 전달함

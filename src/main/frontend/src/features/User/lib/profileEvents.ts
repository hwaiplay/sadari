/**
 * src/main/frontend/src/features/User/lib/profileEvents.ts 파일의 프론트엔드 화면, API, 훅 또는 유틸 로직을 담당
 *
 * @author HanWon.Jang
 */
...
/**
 * notify User Profile Updated 사용자 동작을 처리
 *
 * @author HanWon.Jang
...
export function notifyUserProfileUpdated(profile: UserProfile) {
  // 프로필 저장 결과를 공통 Query 캐시에 반영해 모든 화면을 함께 갱신

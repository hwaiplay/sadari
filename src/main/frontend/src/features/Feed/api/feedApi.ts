...
/**
 * 로그인 사용자 본인과 팔로우하는 활성 사용자의 공개 활동 피드 한 페이지를 조회한다
 *
 * @author HanWon.Jang
...
export const getFeedPageApi = async (page: number): Promise<PageData<FeedItem>> => {
  // 서버가 인증 사용자와 페이지 조건으로 제한한 본인 및 팔로잉 피드를 조회한다

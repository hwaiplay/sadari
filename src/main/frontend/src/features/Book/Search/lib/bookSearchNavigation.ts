...
/**
 * 도서 검색에서 독서 타이머로 돌아갈 때 전달하는 화면 이동 상태
 */
...
/**
 * 타이머에서 시작한 도서 등록을 마친 뒤 현재 읽는 도서 모달로 복귀할 경로를 생성
 *

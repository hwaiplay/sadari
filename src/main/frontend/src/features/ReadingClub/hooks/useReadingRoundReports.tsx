/**
 * 완료된 모임 독서 회차의 DONE 독후감 목록 서버 상태를 관리
 *
 * @author HanWon.Jang
 */
...
/**
 * 현재 활성 모임원에게 허용된 완료 회차 독후감 페이지를 조회
 *
 * @author HanWon.Jang

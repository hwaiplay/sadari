 ...
 * author         : HanWon.Jang
 * date           : 2026-07-28
 * description    : 독후감 댓글 목록의 서버 조회 상태를 관리함
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
/**
 * 독후감 번호별 댓글 목록을 React Query 캐시에 저장하여 제공함
 *
 * @author HanWon.Jang
...
export const useReplyList = (target: ReplyTarget, focusReplNumb?: number) => {
  ...
  return useInfiniteQuery({
    ...
    getNextPageParam: (lastPage) => {
      // 서버가 다음 부모 댓글 페이지 존재를 확인한 경우에만 다음 번호를 반환함

...
/**
 * 책 검색 입력과 결과 목록을 표시하고 사용자 동작을 검색 훅에 전달
 *
...
const SearchBookPage = () => {
  ...
  // 검색 입력 영역이 실제로 화면 상단에 고정된 상태를 조회
  ...
  return (
    <main className={styles.page}>
      <Container className={styles.content}>
        ...
        {/* 인기 도서 모드에서만 인기 검색어와 기간 선택을 같은 높이의 한 행으로 제공 */}
        {isPopularMode && (
            ...
            <div className={styles.resultList}>
              {bookResult.map((book, index) => {
                ...
                function handleBookDetailClick(): void {
                  ...
                  // 검색 유형에 맞는 선택 도서 상세 화면으로 이동
                  handleMoreInfo(book);
                }

                /**
                 * 선택한 도서의 작가명을 검색어로 사용해 즉시 조회
                 *
                 * @author SeungHyeon.Kang
                 * @return 반환값이 없음
                 */
                function handleAuthorClick(): void {
                  ...
                  // 선택한 작가명을 입력창과 검색 결과에 함께 반영
                  void handleAuthorSelect(author);
                }

                // 검색된 책의 요약 정보와 동작 버튼을 반환
                return (
                  <article
                  ...
                  >
                    ...
                    {/* 인기 도서는 표지 아래와 제목 위에 순위 및 작성자 수를 표시 */}
                    {isPopularMode &&
                      book.rank !== undefined &&
                    ...
                    <div className={styles.bookMeta}>
                      ...
                      {isPopularMode ? (
                        /* 인기 도서는 출판사 대신 도서 정보와 같은 평균 별점을 표시 */
                        <div className={styles.authorRatingLine}>
                          ...
                          {/* 평균 평점이 있으면 저자 옆에 구분선과 도서 평균 별점을 표시 */}

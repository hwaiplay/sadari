...
`BookCoverColorService`는 카카오 도서 표지를 분석해 `BOOK_COLR` 공통코드 중 가장 가까운 색상을 선택한다.
...
`BOOK_COLR` 팔레트는 기존 파스텔 중심 20색에 아래 6색을 추가해 26색으로 확장했다. 난색, 저명도 색상, 중성색 영역을 보완해 표지 대표색과 가까운 후보를 선택할 수 있다.

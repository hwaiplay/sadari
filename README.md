...
API 응답 시간과 별도로 격리 MySQL 8.4.10에서 최근 5년 목표 329건과 완료 90%·읽는 중 10% 분포를 사용해 데이터 규모별 JDBC 실행 시간도 비교했습니다. 준비 5회 후 30회 반복한 단일 연결 측정값입니다.
